defmodule MfBackendWeb.Router do
  use MfBackendWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MfBackendWeb.Layouts, :root}
  ...
  if Application.compile_env(:mf_backend, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MfBackendWeb.Telemetry
